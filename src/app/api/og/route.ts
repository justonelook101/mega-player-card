...
export async function GET(request: NextRequest) {
  ...
  const title = searchParams.get('title') || 'MEGA Video Player'
  ...
  const svg = `
    <svg width=\"1200\" height=\"630\" xmlns=\"http://www.w3.org/2000/svg\">
      ...
      <text x=\"600\" y=\"450\" font-family=\"Arial, sans-serif\" font-size=\"24\" fill=\"#9ca3af\" text-anchor=\"middle\">MEGA Player Card</text>
    </svg>
  `
